...
function ParticipantProfileTab({ participant, registrations, loading, onClear, onScanResult, user, onLogout, setViewingRules, rulesMap }) {
  ...
  return (
    <div className="lp-profile-tab">
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0, textAlign: 'left' }}>
                <div style={{
                  ...
                  <img src="/inspico-logo.svg" alt="Inspico" style={{ width: 18, height: 18, filter: 'brightness(0) invert(1)' }} />
                </div>
                <div style={{ minWidth: 0 }}>
                  <p style={{ margin: 0, fontSize: 12.5, fontWeight: 700, color: '#fff', letterSpacing: '-0.2px' }}>
                    Install Inspico App
                  </p>
                  <p style={{ margin: '1px 0 0 0', fontSize: 11, color: 'rgba(255, 255, 255, 0.45)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
          ...
          {!isInstalled && (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: '#fff', letterSpacing: '-0.2px' }}>
                    Install Inspico App
                  </p>
                  <p style={{ margin: '1px 0 0 0', fontSize: 11, color: 'rgba(255, 255, 255, 0.45)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
      ...
      {/* ── Manual / iOS Installation Modal (Pro Icons Only) ── */}
      {showIosGuide && (
        <div
          style={{
            position: 'fixed',
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{
                  ...
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4f9cf9" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                    <polyline points="7 10 12 15 17 10" />
                    <line x1="12" y1="15" x2="12" y2="3" />
                  </svg>
                </div>
                <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: '#fff' }}>Install Inspico App</h3>
              </div>
              <button
                type="button"
                onClick={() => setShowIosGuide(false)}
            ...
            <p style={{ margin: '0 0 16px 0', fontSize: 12.5, color: 'rgba(255, 255, 255, 0.65)', lineHeight: 1.5 }}>
              Follow these simple steps to add Inspico directly to your device home screen:
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 20 }}>
              <div style={{
                ...
                <span style={{ fontSize: 12.5, color: 'rgba(255, 255, 255, 0.85)', lineHeight: 1.4 }}>
                  1. Tap the <strong>Share</strong> button in browser toolbar
                </span>
              </div>
